...
if p_value < alpha:
    print("Il existe une corrélation entre le no voie et la valeur foncière.")
else:
    print("Il n'existe pas de corrélation significative entre le no voie et la valeur foncière.")
...
plt.title('Corrélation entre le no voie et la valeur foncière')
plt.show()